    ...
    fun outputRuns() {
        try {
            ...
            csvWriter.write(listOf(
                ...
                "Verification Time", "Execution Time", "Aggregate operation Time", "Aggregate Record(IC) Fetch Time", "Aggregate Sig Generation time", "AGG_finalVerificationtime(microsec)"
            ))
